...
class CenterpointeDiningDataGenerator:
    ...
    def _load_default_config(self) -> Dict:
        ...
        return {
            ...
            # Academic Calendar & Seasonal Effects
            'academic_calendar': {
                'semester_dates': {
            ...
            'staffing_model': {
                'roles': {
                    ...
                    'Management': {
                        ...
                        'base_hours_per_period': 2.0,   
                        'volume_scaling_factor': 0.82,    # Least variable
                        'minimum_coverage_hours': 1.5,  
                        'peak_hour_multiplier': 1.05,  
                        'efficiency_factors': {
                            'experienced_staff': 1.10,  
                            'new_hires': 0.80,         
